// [] Nessa etapa você deve criar duas rotas: uma para apresentar os dados do professor (show)
// [] e outra para a edição dos dados cadastrados (edit). Além disso, realize a formatação dos dados cadastrados para a correta exibição no HTML
